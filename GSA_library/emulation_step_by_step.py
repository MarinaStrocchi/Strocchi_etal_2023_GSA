...
def emulation_step_by_step(loadpath,
                           idx_feature,
                           savepath):
    ...
    if not os.path.exists(loadpath + "X.txt"):
        raise Exception('The loadpath should contain X.txt.')
    if not os.path.exists(loadpath + "Y.txt"):
        raise Exception('The loadpath should contain Y.txt.')
    if not os.path.exists(loadpath + "xlabels.txt"):
        raise Exception('The loadpath should contain xlabels.txt.')
    if not os.path.exists(loadpath + "xlabels.txt"):
        raise Exception('The loadpath should contain ylabels.txt.')
    ...
    if len(xlabels)!=X.shape[1]:
        raise Exception('xlabels.txt and X.txt dimensions do not match')
    if len(ylabels)!=Y.shape[1]:
        raise Exception('ylabels.txt and Y.txt dimensions do not match')
